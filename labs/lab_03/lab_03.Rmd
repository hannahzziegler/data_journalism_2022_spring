...
A3:The business' are owned by the spouse of Carol Miller. The business names are Dutch Miller Chevrolet, Dutch Miller of Charleston, Dutch Miller of Charlotte, Dutch Miller Subaru, and DM Motors. All of the businesses are car dealerships. Miller initially voted in favor of the legislation that authorized the program. 
...
miller_loans <- wv_ppp_loans %>%
  filter_all(any_vars(str_detect(., pattern = "DUTCH MILLER"))) 
