...
**A1.** The region of the state that appears to have the highest total loan amount is the southwestern and northwestern parts of the state. There is a geographic pattern in the data that suggests the mining industry is a main source of the western part of the state's economy, while the grey parts of the state that do not have any data are concentrated in the eastern part of the state. The county with the highest total loan amount was Harrison county. The total loan amount per the 100k population in Harrison County was 14607650.03. The total amount of loans was 9919762.98, there were 59 loans, and the population is 67908. Harrison County did not have the highest amount of loans per 100k people, though. Ritchie County, with a population of 9844, nine loans and loan amount per 100k of 77752742.79, took that title. The total amount of loans issued to Ritchie County was 7653980.00. 
