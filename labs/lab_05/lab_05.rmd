...
The county is Berkeley County. The city in the county with the highest number of loans is Martinsburg. 
...
berkeley_ppp_with_naics <- berkeley_clean_cities %>% left_join(naics_codes, by="naics_code")
