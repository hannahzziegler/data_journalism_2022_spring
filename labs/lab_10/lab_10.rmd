...
**A1.** The state with the most PPP applications from barber shops is Illinois. There are 1,713 loans to barber shops that are undisbursed in the state. Illinois had the most undisbursed applications. Link to visualization: https://datawrapper.dwcdn.net/MpUIN/1/. 
