...
**Answer** They all have the same column structure. 
...
**Answer** There are 190787 rows in maryland_ppp.
...
**Answer** We get an error message in 'join_rows()'. This error is because the ZIP codes are different character types. 
...
**Answer** Not every row has demographic data in this dataset. 
...
**Answer** Now it seems that every row does have demographic data. 
...
**Answer** The number of loans that went to ZCTAs with more than 50% non-Hispanic Black population is 42,968. The average amount of these loans is $55,546.84 and the median amount for the loans is $19,949.
...
**Answer** The number of loans that went to ZCTAs with more than 50% non-Hispanic white population is 112,056. The average amount of these loans is $89,194.67 and the median amount for the loans is $20,833.
...
**Answer** The number of loans that went to ZCTAs with more than 50% non-Hispanic Black rural populations is 145. The average loan amount for this population is $44,815.22 and the median loan amount for this population is $19,064.57. The number of loans that went to ZCTAs with more than 50% non-Hispanic Black urban population is 41,823. The average loan amount for this population is $55,584.05 and the median loan amount for this population is $19,950.00.
...
**Answer** The number of loans that went to ZCTAs with more than 50% non-Hispanic white rural populations is 18083. The average loan amount for this population is $74,463.32 and the median loan amount for this population is $20,833. The number of loans that went to ZCTAs with more than 50% non-Hispanic white urban population is 93,973. The average loan amount for this population is $92,029.39 and the median loan amount for this population is $20,833.
