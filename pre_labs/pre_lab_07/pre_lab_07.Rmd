...
**Answer** The end result is a dataframe that includes all of the data that we need in our table. It includes the sector, description of the sector and the number of employees for November 2021. 
