...
**Answer** The output includes a table tha tincludes the 20 sectors and descriptions from table #2 on the html site. 
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** There are more tables that display the data present in this page, including the employment and unemployment information for the utilities workforce. 
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** The output includes html nested with head and body tags that describe the layout of the webpage. It is a list of 2 in the environment. 
...
**Answer** The code outputs the html element descriptions that correspond to the table that we want to see. It shows the tags repated to the table with employment information. We used html element to filter for only the element that we want -- in this case the November 2021 employment and unemployment data. 
...
**Answer** The codeblock below includes six columns with six rows. One is called "data series" with employment and unemployment information. The other column has backdata and is mostly empty. Every other column has the data for each of the months from the original table. 
...
**Answer** The output appears as each sector name standardized and ready to be used as column names in the dataframe. 
```{r}
...
**Answer** It names the columns after each sector that we need to examine to create this dataframe. 
```{r}
