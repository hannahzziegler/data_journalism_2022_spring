...
**Answer** The output that appears below the codeblock appears to have HTML code within it. R is holding the HTML page source within it.
...
**Answer** There are six different tables that R produces of each table that was present on the original html page. 
...
**Answer** The scroll icon produces a table with the data that corresponds to the format that is outlined in the original List of 6 that was present before clicking. 
