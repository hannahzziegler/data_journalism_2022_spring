...
**Answer** The codeblock adds the tag to the html table that contains the information that we want to use from each page, in this case the employment table. 
...
**Answer** The codeblock deletes the row pertaining to Public Administration sector. 
...
**Answer** The output gives a separate dataframe from each naics industry with the employment and unemployment data from the html page. Each dataframe contains employment numbers for each sector. 
