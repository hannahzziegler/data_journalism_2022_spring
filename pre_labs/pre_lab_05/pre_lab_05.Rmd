...
**Answer** 195,865 records are in this table. 
...
**Answer** The cities are not standardized with their capitalizations and spellings and there could be duplicates of some. 
...
**Answer** It changed whether some cities were uppercase and lowercase based on how common it is that they appear in that case. For example, it made all mentions of Easton uppercase and changed all mentions of cities like Chevy Chase and Westminster to title case. 
...
**Answer** The city_clean column made Abell into title case from all uppercase, it changed the uppercase iterations of Aberdeen to title case and changed the uppercase iterations of Aberdeen Proving Ground to title case. 
...
**Answer** It does not seem like the n_gram_merge() function made any substantial, difference changes to the data compared to the previous use. 
