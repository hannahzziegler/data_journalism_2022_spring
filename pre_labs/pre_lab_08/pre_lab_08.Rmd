...
**Answer** The state with the largest percentage of population growth between 2000 and 2010 is Nevada. 
...
**Answer** Calvert County has a much wider margin of error bar than Montgomery County, but the bars overlap, which shows that the differences between these two counties are not statistically statistically significant. 

Is the difference between Howard and everyone else significant?
**Answer** The difference between Howard County and every other county is significant. The Howard County bar does not overlap with the bars for any other county. 
...
**Answer** Somerset County and Caroline County both saw their median incomes fall from 2010-2019. The change is not outside the margin of error for either county, meaning that it is not statistically significant. 
...
**Answer** Only two ZIP codes of those with the largest amounts have a median household income of less than $50,000: 21201 and 21740.
