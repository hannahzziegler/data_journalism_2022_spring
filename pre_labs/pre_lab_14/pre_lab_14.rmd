...
**Answer** The dataframe that this code outputs is a table of federal politicians' tweets that contain either "COVID" or "coronavirus." There are 152,000 tweets that are described with 12 columns 
...
**Answer** The unique function still shows differences in capitalization between dog and Dog, but it does combine the two repeated "cat" words. 
...
**Answer** The new dataframe has two columns of content and changes all of the text to lowercase text and removes all of the punctuation. THere are 5,000,000 unique words in this dataframe. 
...
**Answer** The resulting graphic mostly has the most common words, generic in the English language that appear most in the tweets. These words include "the", "to", and "and." This graphic is not super interesting to me, but makes sense because people use generic words like these so much. 
...
**Answer** The code below takes out all of the stop words from our dataframe and we now have a table of the msost common words in these tweets using anti-join. Now, we can see that "covid", "19" and "covid19" are the most common mentions of words in tweets from federal politicians relating to COVID-19. It is more targeted to the topic of the pandemic at hand. 
...
**Answer** The two datatables that appear below have many of the same main words that are listed above in the one that isn't divided by year. The 2021 dataframe has words like "vaccine," which are not present in the other dataframe because vaccinations weren't as widely talked about in the earlier days of the pandemic. 2020 also has words like "crisis", while the 2021 datatable doesn't use this harsh language in the tweets from federal politicians. 
...
**Task** Run the following code and describe the results.
**Answer** The results include percentages of words like "covid 19", "health care" and "public health." We see more phrases associated with the pandemic and its response in this dataframe, especially because the data shows us tweets about "town halls", "covid relief" and "relief package."
...
**Task** Run the following code and describe the results.
**Answer** After 2021, phrases like "health care" and "public health" are still among the top 10 two-word phrases. There are many more occurrences of tweets in 2021 that talk about the vaccine, which makes sense because of the development of vaccines during the latter half of 2020 and first part of 2021. 
...
**Task** Run the following code and describe the results.
**Answer** Republicans and Democrats had very similar terms to refer to the pandemic, but with varying frequencies. There are some party discrepancies, such as Republicans having more usage of "American people" and Democrats having more usage of "social distancing." However, both parties had frequent use of "covid-19" and "healthcare." Republicans also had many more mentions of the CARES Act and generally had fewer tweets about the pandemic overall. There is more emphasis on healthcare and public health on the Democrat's side, while Republicans didn't have as many mentions of that and stuck much more to COVID-related terms. 
...
**Task** Run the following code and describe the results.
**Answer** In 2020, Republican House candidates had a much higher percentage of referencing "president trump", "american people" and "god bless." In 2021, there are more polarizing terms such as "illegial immigrants", "covid positive" and "vaccine mandates." There is also mention of President Biden and less mention of God blessing the American people in 2021. 
...
**Answer** Most of the sentiments here seem to describe the words being used accurately when the words are seen as standalones. I would like to know the context where some of these words are used, such as "positive" because this could be referencing a person who has tested positive for COVID, which is obviously a negative thing. 
