...
**Answer** The code is grouping the data by the county in which the project took place and then gets the total number of loans for each county. Then it arranges these numbers in descending order and displays the new dataframe with the completed results. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The text has better spacing and a bolded title that describes the graph. The name of the y axis is also not descriptive to the data. It also adds a caption that attributes the data somewhere. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The code has a line chart with total loans on the y axis and the approval date on the x axis. The date approved values on the x axis are also very spread out. 
