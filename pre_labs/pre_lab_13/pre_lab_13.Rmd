...
**Answer** The table outputs a .52 correlation between businesses receiving PPP loans and the percentage of their population that voted for Trump. The table also shows a weak .22 correlation between the PPP loan amount per employee and how much of the population voted for Trump. 
```{r}
reveal_data %>%
...
**Answer** The output gives a p value of 0.00008607 at a 95 percent confidence interval. 
```{r}
...
**Task** Run the following code. Describe the model output. What do you see?
**Answer** This output gives a p-value of 0.1189, meaning that ____. 
```{r}
