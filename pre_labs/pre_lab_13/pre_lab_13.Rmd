...
**Answer** , meaning that the t value is low, the p value is pretty high, and there are not a lot of meaningful correlational results from analysis of this data. 
```{r}
